...
export const metadata = buildMetadata({
  ...
  description:
    "How Advanced Software and AI Solutions LLC collects, uses, and shares information on the marketing website, contact form, and product waitlists.",
  path: "/privacy",
});
    ...
    <section className="section">
      <div className="container">
        ...
        <div className="prose">
          ...
          <p>
            This policy covers the <strong>marketing website, contact form, and
            product waitlist / interest signups on the Site</strong>. BriefSeal,
            EmailArchiver, and other ASAIS products have (or will have) their own
            privacy notices when you use those services.
          </p>
          <p>
          ...
          <p>
            <strong>Contact / inquiry form.</strong> If you use the contact form
            or email us, we collect:
          </p>
          <div className="table-wrap">
            <table>
              <thead>
          ...
          <p>
            <strong>Product waitlist / interest.</strong> If you join a waitlist
            or interest list for BriefSeal, EmailArchiver, or another ASAIS
            product on the Site, we collect:
          </p>
          <div className="table-wrap">
            <table>
              <thead>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>Yes (which product list you joined)</td>
                </tr>
                <tr>
                  <td>Name or company</td>
                  <td>Optional, only if the form asks</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p>
            ...
            card numbers, or government ID numbers through Site forms. Please do
            not send passwords or highly sensitive personal data through those
            forms.
          </p>
          ...
          <p>
            We use <strong>product waitlist / interest emails</strong> only to:
          </p>
          <ul>
            <li>Confirm you joined the list (if we send a confirmation)</li>
            <li>
              Notify you about launch, early access, or material updates for the
              product(s) you selected
            </li>
            <li>
              Measure aggregate interest (counts), without selling your email
            </li>
          </ul>
          <p>
            We do <strong>not</strong> sell personal information. We do{" "}
            <strong>not</strong> share Site contact or waitlist submissions with
            unrelated third-party advertisers. We do <strong>not</strong> use
            waitlist emails to market unrelated ASAIS services unless you
            separately ask us to (for example via the contact form) or we get
            your clear opt-in first.
          </p>
          ...
          <p>
            To request deletion of a contact submission or removal from a product
            waitlist, email{" "}
            <a href="mailto:contact@advancedsoftwareandaisolutions.com">
              contact@advancedsoftwareandaisolutions.com
            </a>{" "}
            (subject: Privacy or Unsubscribe). We may keep limited records when
            required by law or for security and accounting (for example, a
            suppression list so we do not email you again by mistake).
          </p>
          ...
          <p>
            ...
            contact or waitlists, to correct it, or to request deletion, subject
            to applicable law.
          </p>
          <p>
