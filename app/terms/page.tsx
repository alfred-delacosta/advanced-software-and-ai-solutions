    ...
    <section className="section">
      <div className="container">
        ...
        <div className="prose">
          ...
          <p>
            Availability, pricing, and features may change. Live products
            (including BriefSeal and EmailArchiver) are governed by their own
            terms, pricing, and security disclosures when published on those
            product sites.
          </p>
          ...
          <ul>
            ...
            <li>
              Impersonate ASAIS or misrepresent your affiliation with us
            </li>
          </ul>
          <p>We may suspend or block access that appears abusive.</p>

          <h2 className="h2">4. Contact form and email</h2>
